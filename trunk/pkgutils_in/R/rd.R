...
#'   links in the \code{seealso} section shall be removed.
#' @param text.dups Logical scalar indicating whether duplicate words within
#'   text content should be noted.
#' @param file Optional character scalar indicating the name of the file from
#'   which the \sQuote{Rd} object was read. Useful when creating messages
#'   describing a problem. See \code{\link{logfile}}.
...
#'   that comes with \R{}, and for fitting to the \code{docType} entry of the
...
#'   combined with other keywords, and that \code{docType} entries such as
...
#'   \sQuote{internal}. Otherwise they should be present unless \code{docType}
...
#'
#' Repair S4 documentation in Rd files by adding \code{docType}, \code{usage},
#' and \code{alias} entries.
#'
...
#'   can also recognise S4 methods generated within a loop provided a specific
