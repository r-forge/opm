...
#'   \item{scripts}{\command{Rscript} scripts for non-interactive use of \R. The
#'     one used to create, check and modify package documentation is
#'     \command{docu.R}. The other scripts have no connection to creating
#'     packages but might also be useful. See the help messages of these scripts
