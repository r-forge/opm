...
See Section~\ref*{tutorial-methods plotting} in the main tutorial for details on this kind of plotting.
...
See Section~\ref*{tutorial-methods aggregating} in the main tutorial for details on aggregation methods.
...
% remaining code
%
%x <- ci_plot(sp.agg.sm.d, as.labels = list("Genotype"),
%  subset = "AUC", x = "bottomright", legend.field = NULL)
% here: extend the ci-plot with the other two datasets
%
%#pdf("heatmapDM.pdf")
%par(mfrow=c(1,3))
%heat_map(sp.agg.sm.d, as.labels = "Genotype", as.groups = "Genotype")
%heat_map(sp.agg.tp.d, as.labels = "Genotype", as.groups = "Genotype")
%heat_map(sp.agg.p.d, as.labels = "Genotype", as.groups = "Genotype")
%#dev.off()
%

% here starts the E. coli part

%x <- ci_plot(tp.tecan, as.labels = list("Strain"),
%  subset = "AUC", x = "bottomright", legend.field = NULL)
%
%x <- ci_plot(sm.tecan, as.labels = list("Strain"),
%  subset = "AUC", x = "bottomright", legend.field = NULL)
%
%x <- ci_plot(p.tecan, as.labels = list("Strain"),
%  subset = "AUC", x = "bottomright", legend.field = NULL)
%
%
%#pdf("heatmapDM.pdf")
