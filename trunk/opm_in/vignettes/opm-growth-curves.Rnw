...
This file was output by an Infinite\textregistered \ 200 PRO
%\rcsmark{[Lea, please enter the name]}
instrument as distributed by the TECAN corporation.
After recording the data, the Magellan\textsuperscript{TM}
%\rcsmark{[Lea, please enter the name]}
software provided by TECAN generated such as file \textit{via} the ``save as excel'' or the ``save as .asc'' option in the ``edit'' menu.
%\rcsmark{[Lea, please enter the procedure]}.
...
xy_plot(potato.fm, theor.max = FALSE, rcr = 1, include = "Genotype",
  main = list(in.parens = FALSE), ylab = "Fresh cell mass [mg]", neg.ctrl = FALSE)
@
