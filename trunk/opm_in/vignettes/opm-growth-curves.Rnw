...
With the \code{reshape} it is possible to rearrange the data set in a form, where the columns ``Genotype'', ``Treatment'' and ``Replicate'' are kept and columns ``Time'' and either ``\ac{FM}'', or ``\ac{DM}'' respectively, are merged resulting in 9 columns representing the measurement times.
...
An input file comes along with \pkg{opm}, providing growth curve data which were derived from an growth challenging experiment with two \textit{Escherichia coli} strains (\ac{DSM} 18039 $=$ K12 and the type strain \ac{DSM} 30083\textsuperscript{T}) on increasing Glucose concentrations.
...
register_plate(growth = c(A01 = "negative control", A02 = "10mM Glucose",
A03 = "20mM Glucose", A04 = "50mM Glucose", A05 = "100mM Glucose",
A06 = "200mM Glucose",
B01 = "negative control", B02 = "10mM Glucose",
B03 = "20mM Glucose", B04 = "50mM Glucose", B05 = "100mM Glucose",
B06 = "200mM Glucose",
C01 = "negative control", C02 = "10mM Glucose",
C03 = "20mM Glucose", C04 = "50mM Glucose", C05 = "100mM Glucose",
C06 = "200mM Glucose",
D01 = "negative control", D02 = "10mM Glucose",
D03 = "20mM Glucose", D04 = "50mM Glucose", D05 = "100mM Glucose",
D06 = "200mM Glucose"),
growth = "growth")
#listing(wells(plate = "custom:growth"))
@

However, this procedure is error prone and not efficient, if dealing with set ups for more than a few wells.
Thus we show how to register a user-designed plate with plate map given as matrix, which depicts the allocation of the used substrates on the plate.

First, the matrix for the plate map is set up
...
\begin{figure}
\centering
<<label=xy-plot,fig=TRUE>>=
xy_plot(y, theor.max = FALSE)
@
\caption{
