...
The next step is the estimation of curve parameters.
Using \code{do_aggr} is the fast and easiest option. 
See Section~\ref*{tutorial-methods aggregating} in the main tutorial for details of aggregation methods.
