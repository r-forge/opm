...
In the examples detailed above, a variety of such objects have already been generated, e.g.,
...
%TODO
% explain the color-arguments and the scaling properly
...
<<label=randomforest-figure, fig=TRUE>>=
...
%TODO separate figure from shown code, as for all other figures
...
% TODO LATER ask Barry for the measurements from the autism paper for using them as coding example
