...
A list of the existing maps and their corresponding numbers are available under \url{http://www.genome.jp/kegg-bin/get_htext#B1}.
...
%TODO 
% explain the wrapper
% change the default of kegg.native to TRUE
% explain, why the output of .png is choosen as default
% 
...
old.mar <- par(mar = c(3, 43, 3, 2)) # adapt plotting settings
