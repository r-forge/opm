...
\begin{figure}
 \centering
\scalebox{1.1}{
<<label=e-coli-comp-ci-figure, fig=TRUE, echo=FALSE, width=14, height=9>>=
old.mar <- par(mar = c(3, 31, 3, 0.5)) # adapt plotting settings
...
contr <- rbind(
  "Carbohydrates/DSM18039 - Carbohydrates/DSM30083T" = c(carb.vec, 
  carb.vec.fill),
...
According to the explanation given to Figure~\ref{fig:var-imp-plot}, the comparison shows, that one of the strains performs stronger than the other particularly regarding carbohydrate utilisation.
