...
\begin{figure}
 \centering
        \begin{subfigure}[b]{1.0\textwidth}
                \centering
                \fbox{\includegraphics[width=14cm,type=png,ext=.png,read=.png]{ko00052.cat-coli-comp-0}}
        ...
        \begin{subfigure}[b]{1.0\textwidth}
                \centering
                \fbox{\includegraphics[width=14cm,type=png,ext=.png,read=.png]{ko00052.cat-coli-comp-150}}
...
%TODO is this printable? The bottom margin might be too low. Same questions holds for all previous pictures with two pathway maps.
