...
By default this yields CAS numbers, but MeSH, ChEBI \citep{Hastings01012013}, KEGG compound, KEGG drug \citep{Kanehisa01012010} and MetaCyc \citep{Caspi01012012} IDs have also been collected for the majority of the substrates.
