...
In addition to 95\% confidence plots and enhanced heat-map graphics for visual comparisons of the estimated curve parameters the package includes functionality for multiple comparisons of group means.
...
{\color{red} TODO Lea Hier absatz ueber statistische vergleiche einfuegen
literature ins bibtex-file einpflegen
...
Schaarschmidt F, Vaas L (2009) Analysis of trials with complex treatment structure using multiple contrast tests, HortScience 44(1):188-195 }
...
\subsection[Statistical analysis of aggregated data]{Statistical analysis of aggregated data}

{\color{red} TODO Lea Introduce functionality of \code{opm\_mcp()} and \code{extract()}}
...
\subsection[Statistical comparison of aggregated data]{Statistical comparison of aggregated data}

{\color{red} TODO Lea: here the application of \code{opm\_mcp()} with example and output-graphics.}
