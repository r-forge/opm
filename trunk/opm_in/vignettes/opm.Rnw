...
%% TODO Lea Hier absatz ueber statistische vergleiche einfuegen
...
%% TODO Lea: Point also on Fig. 2. Explain the right part of the figure.
...
%%TODO Lea: Explanation of Figure 3.
...
%% TODO Lea Explain the normalisation method from extract()
...
%% TODO Lea Introduce functionality of \code{opm\_mcp()} and \code{extract()}
