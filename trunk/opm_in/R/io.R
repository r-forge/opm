...
#'   \item Pseudo-\acronym{CSV} file in the old style (before 2011).
...
#' Input metadata (helper function)
#'
#' A helper function for \code{\link{collect_template}}.
#'
#' @param object Data frame as generated by \code{\link{collect_template}}.
#' @param outfile See \code{\link{collect_template}}.
#' @param sep See \code{\link{collect_template}}.
#' @param previous See \code{\link{collect_template}}.
#' @param md.args See \code{\link{collect_template}}.
#' @return Data frame.
#' @keywords internal
#'
...
#'   \code{outfile} and for the input file of \code{to_metadata} (which ignores
