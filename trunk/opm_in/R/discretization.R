...
#'   object.
#' @param cutoff Determines the discretisation approach. If not \code{NULL},
#'   passed as \code{range} argument to \code{discrete} (with \code{gap} set to
#'   \code{TRUE}), thus triggering discretisation using either k-means
#'   partitioning or one or two predefined thresholds. If \code{NULL}, a
#'   discretisation cutoff is determined using \code{\link{best_cutoff}}, which
#'   is only possible for \code{\link{OPMS}} objects.
