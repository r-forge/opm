...
# fuer Lea
# oeffne LEA_Entwicklungs_anleitung.R, gehe in Rstudio auf 'Tools' und setze 
# 'set working directory' -> To Source File Location
# dann ist man im richtigen verzeichnis
# danach library(testthat) und pack_desc("opm_in", action = "source")
